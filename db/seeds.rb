...
a1 = Album.create(
  cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/my-beautiful-dark-twisted-fantasy.jpg', title: 'My Beautiful Dark Twisted Fantasy', artist: 'Kanye West'
)
...
a2 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/beyonce.png',
                  title: 'Beyonce', artist: 'Beyonce')
...
a3 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/21.png', title: '21',
                  artist: 'Adele')
...
a4 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/channel-orange.jpg',
...
a5 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/good-kid-maad-city.jpg',
...
a6 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/ram.jpg',
...
a7 = Album.create(cover: 'http://s3.amazonaws.com/codecademy-content/projects/3/bass-music/the-2020-experience.png',
                  title: 'The 20/20 Experience', artist: 'Justin Timberlake')
...
a8 = Album.create(cover: 'https://media.pitchfork.com/photos/5ae76b35eaa03d5ad95c5ada/1:1/w_320/dirtycomputer.jpg',
                  title: 'Dirty Computer', artist: 'Janelle Monáe')
Track.create(name: 'Dirty Computer', minutes: 2, album_id: a8.id)
Track.create(name: 'Crazy, Classic, Life', minutes: 5, album_id: a8.id)
Track.create(name: 'Take a Byte', minutes: 4, album_id: a8.id)
Track.create(name: "Jane's Dream", minutes: 0, album_id: a8.id)
Track.create(name: 'Screwed', minutes: 5, album_id: a8.id)
Track.create(name: 'Django Jane', minutes: 3, album_id: a8.id)
Track.create(name: 'Pynk', minutes: 4, album_id: a8.id)
Track.create(name: 'Make Me Feel', minutes: 3, album_id: a8.id)
Track.create(name: 'I Got the Juice', minutes: 4, album_id: a8.id)
Track.create(name: 'I Like That', minutes: 3, album_id: a8.id)
Track.create(name: "Don't Judge Me", minutes: 6, album_id: a8.id)
Track.create(name: "Stevie's Dream", minutes: 1, album_id: a8.id)
Track.create(name: 'So Afraid', minutes: 4, album_id: a8.id)
Track.create(name: 'Americans', minutes: 4, album_id: a8.id)

a9 = Album.create(cover: 'https://cdbaby.name/k/u/kungfu3.jpg', title: 'Joyride', artist: 'Kung Fu')
Track.create(name: 'Daddy D', minutes: 5, album_id: a9.id)
Track.create(name: 'Chin Music', minutes: 8, album_id: a9.id)
Track.create(name: 'Vroom', minutes: 8, album_id: a9.id)
Track.create(name: 'Joyride', minutes: 6, album_id: a9.id)
Track.create(name: 'Speed Bump of Your Love', minutes: 6, album_id: a9.id)
Track.create(name: 'Primetime Rib', minutes: 7, album_id: a9.id)
Track.create(name: 'The Get Down', minutes: 7, album_id: a9.id)
Track.create(name: 'Gold Coast', minutes: 8, album_id: a9.id)
Track.create(name: 'Samurai', minutes: 9, album_id: a9.id)
